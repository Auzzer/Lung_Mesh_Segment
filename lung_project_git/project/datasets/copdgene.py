    ...
    def examples(
        ...
        for subj in subjects or self.subjects():
            ...
            for fixed, moving in pairs:
                ...
                paths = {}
                paths['ref_image'] = self.path(subj, self.SOURCE_VARIANT, visit, self.DEFAULT_STATE, recon, asset_type='image')
                paths['fixed_source'] = self.path(subj, self.SOURCE_VARIANT, visit, fixed, recon, asset_type='image')
                paths['moving_source'] = self.path(subj, self.SOURCE_VARIANT, visit, moving, recon, asset_type='image')
