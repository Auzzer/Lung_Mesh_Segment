...
def compute_mesh_hu(
    ...
    affine_inv = np.linalg.inv(img.affine).astype(np.float32)
    ...
    affine_inv_t = torch.from_numpy(affine_inv).to(torch_device)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--preprocessed",
        default="data_processed_deformation/Case10Pack/Case10Pack_T00_to_T10_lung_regions_11.npz",
    ...
    parser.add_argument(
        "--output",
        default="data_processed_deformation/Case10Pack/Case10Pack_T10_to_T00_with_hu.npz",
