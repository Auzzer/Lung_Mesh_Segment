...
def main() -> None:
    ...
    alpha_wrong = alpha_true * 0.8
    beta_wrong = beta_true * 0.8
    kappa_wrong = kappa_true * 1.2

    visualization_dir = base_dir / "comparison"
    ...
    true_results = _run_case(
        ...
        beta_true,
        kappa_true,
        visualization_dir / "cone_sms_true_params",
        "true",
    )
    ...
    wrong_results = _run_case(
        ...
        beta_wrong,
        kappa_wrong,
        visualization_dir / "cone_sms_wrong_params",
        "perturbed",
    )
    ...
    diff_path = visualization_dir / "cone_sms_true_vs_wrong_difference.xdmf"
    meshio.write(str(diff_path), diff_mesh, data_format="XML")
